...
export const register = async (req, res) => {
    ...
    try {
        ...
        // script for sending welcome email
        const mailOptions = {
            from: process.env.SENDER_EMAIL,
            to: email,
            subject: `Welcome ${name} 😎`,
            text: `Welcome to my site.Your account has been created with email :${email}`
        }
...
export const sendVerifyOtp = async (req, res) => {
    try {
        ...
        await user.save()
        //  now we will send otp through email.
        const mailOptions = {
            from: process.env.SENDER_EMAIL,
            to: user.email,
...
// received otp-->now we will add otp in site and verifiy
...
// user verfiy otp->then reset password
